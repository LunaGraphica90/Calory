...
?>
        ...
        <section id="about" class="mentionslegales">
            <div class="content-about">
                ...
                <p>
                    Le site <?=$urlCourteLienSiteWeb?> peut-être amené à vous demander l’acceptation des cookies pour des besoins de statistiques et d’affichage. Un cookie est une information déposée sur votre disque dur par le serveur du site que vous visitez.<br>
                    <br>
                ...
                <p>
                    Les sites internet peuvent offrir des liens vers d’autres sites internet ou d’autres ressources disponibles sur Internet. <?=$nomUsuelSociete?> ne dispose d’aucun moyen pour contrôler les sites en connexion avec ces sites internet.<br>
                    <br>
                ...
                <h3 id="services">Services fournis</h3>
                <p>
                ...
                <h3 id="limitation">Limitation contractuelles sur les données</h3>
                <p>
                ...
                <h3 id="propIntell">Propriété intellectuelle&nbsp;:</h3>
                <p>
                ...
                <h3 id="rgpd">Règlement général sur la protection des données (RGPD)&nbsp;:</h3>
                <p>                
